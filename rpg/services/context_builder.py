...
def build_player_context(
    *,
    ...
    parts.append(
        ...
        "no more than 5 paragraphs, and no more than 2 direct questions. These are hard "
        "maximums, not targets: shorter is usually better.\n"
        ...
        "normal ACT.\n"
        "Do not deliver long monologues, briefings, manifestos, or knowledge dumps. "
        "Do not dump every fact your character knows just because it is relevant. "
