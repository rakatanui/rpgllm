...
def build_player_context(
    *,
    ...
    parts.append(
        ...
        "Advance ONE immediate beat and do not resolve several beats of the scene at once.\n"
        "HARD LIMITS FOR A NORMAL PUBLIC ACT: no more than 1200 visible characters, "
        "no more than 6 paragraphs, and no more than 2 direct questions. These are hard "
        "maximums, NOT a target or a suggested size. A normal useful ACT should usually fit "
        "in 2-3 paragraphs. Use paragraphs 4-6 only when they are genuinely needed to keep "
        "one immediate beat understandable. Never pad, recap, restate, or add extra dialogue "
        "merely because the hard ceiling allows more space.\n"
        "HARD LIMITS FOR ACT_OUT_OF_TURN: no more than 650 visible characters, "
        "no more than 2 paragraphs, and no more than 1 direct question. Because an "
        "out-of-turn action is an exceptional interruption, keep it much shorter than a "
        "normal ACT.\n"
        "Do not deliver long monologues, briefings, manifestos, scene summaries, "
        "or knowledge dumps. Do not dump every fact your character knows just because it is "
        "relevant. Do not repeat what other characters already know unless the immediate "
